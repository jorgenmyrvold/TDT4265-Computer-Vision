...
from ssd.data.transforms import Normalize, ToTensor, GroundTruthBoxesToAnchors, RandomSampleCrop, Resize
...
anchors = L(AnchorBoxes)(
    ...
    min_sizes=[[15, 15], [50, 50], [111, 111], [162, 162], [213, 213], [264, 264], [315, 315]],
...
backbone = L(backbones.ExtraConvAdam)(
    output_channels=[256, 256, 512, 128, 256, 512],
...
optimizer = L(torch.optim.AdamW)(lr=5e-4, weight_decay=0.0001, amsgrad=True)
